...
// UI Helpers - Top Center Floating Popup Notification
function showToast(message, type = 'info') {
  ...
  toast.innerHTML = `
    ...
    <button class="btn-icon" onclick="this.closest('.toast').remove()" style="width:18px; height:18px; color:var(--text-muted); margin-left:8px; padding:0; background:transparent; border:none; cursor:pointer; display:inline-flex; align-items:center; justify-content:center;" title="Dismiss">
